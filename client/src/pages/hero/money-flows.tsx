  ...
  return (
    <section className="bg-white py-16" role="money-flow">
      <div className="max-w-6xl mx-auto px-6 text-center">
        {/* Title */}
        <h2 className="font-serif text-6xl text-gray-900 font-black">
        ...
        <div
          className="
            relative mt-12 flex justify-center gap-6
          ...
          {TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={[
                  "relative py-4 border-0 text-base font-normal uppercase tracking-normal transition-colors cursor-pointer w-full max-w-40",
        ...
        <div className="relative mt-20 overflow-hidden">
          ...
          >
            {TABS.map((tab) => (
              <div
                key={tab.id}
                className="min-w-full shrink-0 px-2 flex flex-col items-center gap-16 "
              >
                <div className="relative flex items-end justify-center gap-12">
                  <img
                    src={tab.phone}
                    alt={`${tab.label} mobile preview`}
                    className="translate-y-4 self-center drop-shadow-2xl"
                    loading="lazy"
                  />
                  <img
                    src={tab.tablet}
                ...
                <div className="w-full max-w-3xl text-center">
                  <p className="mt-6 text-lg font-medium leading-relaxed text-gray-600">
                    {tab.description}
                  </p>
